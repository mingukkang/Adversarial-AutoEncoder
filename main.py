...
flags.DEFINE_integer("n_epoch", 11, "number of Epoch for training")
flags.DEFINE_integer("n_z", 2, "Dimension of Latent variables")
flags.DEFINE_integer("num_samples",1000, "number of samples for semi supervised learning")
...
if conf.mode is "supervised":
    ...
    op_CE_labels = AAE.optim_op(CE_labels, lr_D_G, global_step, var_generator)
    ...
    if conf.PARR is True:
        ...
        z_concated = np.concatenate([y_one_hot, z_holder], axis=1)
